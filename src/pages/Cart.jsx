...
import { decrementQuantity, deleteItem, incrimentQuantity, resetCart } from "../redux/amazonSlice";
        ...
        products.length > 0 ? (
            ...
            <div className="w-full h-full bg-white px-4 col-span-4">
              <div className="font-titleFont flex items-center justify-between border-b-[1px] border-b-gray-400 py-3">
                <h2 className="text-3xl font-medium">Shopping</h2>
                    ...
                    <div className="w-full flex items-center justify-between gap-6">
                      ...
                      <div className="w-4/5">
                        ...
                        <div className="bg-[#f0f2f2] flex justify-center items-center gap-1 w-24 py-1 text-center drop-shadow-lg rounded-md">
                          ...
                          <p>{item.quantity}</p>
                          <p 
                            onClick={() => dispatch(incrimentQuantity(item.id))}
                            className="cursor-pointer bg-gray-200 px-1 rounded-md hover:bg-gray-400 duration-300">
                            +
                          </p>
                        </div>
              ...
              <div onClick={() => dispatch(resetCart())} className="w-full py-2">
                <button className="px-10 py-2 mt-3 mb-3 bg-red-500 hover:bg-red-600
                        active:bg-red-500 text-white rounded-lg font-titleFont
            ...
            <div className="w-full h-52  bg-white col-span-1 flex flex-col justify-center items-center p-4">
                <div>
                    <p className="flex gap-2 items-start text-sm">
                        ...
                        Your order quanlifles for FREE Shipping Choose 
                ...
                <button className="w-full font-titleFont font-medium text-base
                        ...
                        hover:from-yellow-300 hover:to-yellow-500 border-yellow-500
            ...
            <motion.div 
                ...
                className="flex justify-center gap-4 items-center py-10">
                <div>
                    <img 
                        src={emptyCart} 
                        alt="emptyCartImg" 
                ...
                <div className="w-96 bg-white flex flex-col items-center rounded-md shadow-lg py-6 px-6" >  
                    <h1 className="font-titleFont text-xl mb-2 font-bold">Your Cart feels lonely</h1>
                    <p className="text-sm text-center">
                        Your Shopping cont ives to sarve. Gave it
                        purpase - hil it with books, electronics, videos,
                        etc. and make it happy.
                    </p>
                   <Link to='/'>
