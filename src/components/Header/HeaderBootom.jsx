  ...
  return (
    <div className='w-full px-4 h-[36px] bg-amazon_light text-white flex items-center'>
        ...
        <ul className='flex items-center gap-2 text-sm tracking-wide'>
            <li onClick={() => setSidbar(!sidbar)} className='headerHover flex items-center gap-1'><MenuIcon /> All</li>
            <li className='headerHover hidden md:inline-flex'>Today's Deals</li>
            <li className='headerHover hidden md:inline-flex'>Custamer Service</li>
                    ...
                    <div className='w-full h-full relative'> 
                        <motion.div 
                            ...
                            <span 
                                ...
                                left-[82%] md:left-[360px] w-10 h-10 text-black flex
